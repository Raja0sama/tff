...
(function (root, window, document, factory, undefined) {
  ...
  var VIEWING_PREFIX = "fp-viewing-" + cpid;
  var ACTIVE = "active";
  ...
  function initialise(containerSelector, options) {
    ...
    function moveSectionUp() {
      ...
      //   var element = document.getElementById("footerx");
      //   element.classList.remove("footerstyle");
      try {
        var element = document.getElementById("footerx");
        element.classList.remove("footerstyle");
      } catch {
      ...
      if (prev != null) {
        ...
        // var lik = document.getElementsByClassName('active')[0].dataset.pai ?
        // document.getElementsByClassName('active')[0].dataset.pai:
        // document.getElementsByClassName('active')[1].dataset.pai;
        // console.log(lik);
        // $('header').addClass(lik);
    ...
    function moveSectionDown() {
      ...
      if (next != null) {
        ...
        //element.classList.add(""+lik);
        //alert(lik);
        if ("footer" === lik) {
          setInterval(function () {
            var element = document.getElementById("footerx");
            element.classList.add("footerstyle");
          }, 8500);
        } else {
          //alert('not');
        }
